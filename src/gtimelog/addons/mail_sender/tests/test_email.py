...
from gtimelog.addons.mail_sender.models.email import prepare_message
...
class TestEmail(unittest.TestCase):
    def test_prepare_message_ascii(self):
        ...
        assert msg['From'] == 'ASCII Name <test@example.com>'
        assert msg['To'] == 'activity@example.com'
        assert msg['Subject'] == 'Report for Mr. Plain'
